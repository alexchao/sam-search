        ...
        return (
            <div className="info-box-container">
                <div className="info-box pop-up">
                    ...
                    <p>Most of the transcripts here have been generated directly from <strong>Sam Harris</strong>'s <em><a href="https://www.samharris.org/podcast">Waking Up</a></em> podcast audio data using Google's <a href="https://cloud.google.com/speech/">Cloud Speech API</a>. The speech recognition technology &mdash; while powerful &mdash; is imperfect; the transcripts found here include numerous errors and lack punctuation, and are unable to distinguish between when Sam is speaking in his own words or quoting someone else. Literal reading of these transcripts is difficult, and so they should only be used as reference material.</p>
